...
"""Common keyword or schema citation information."""
...
CITE = dict(
    ...
    ogip_event_lists="I. George, A. Rots , K Mukai, Guidelines For Defining FITS Formats for Event Lists, OGIP Memo 94/003, 1994",
)
